...
<script>
        ...
        wx.ready(function () {
            var shareTimelineData = {
                title: '【性别测试】经鉴定，我的性别指数为：50%纯爷们，50%小婊砸！', // 分享标题
                link: 'http://fenxiao.soundtooth.cn/html5/sextest/share_result_girl6.php', // 分享链接
            ...
            var shareData = {
                ...
                link: 'http://fenxiao.soundtooth.cn/html5/sextest/share_result_girl6.php', // 分享链接
                imgUrl: 'http://fenxiao.soundtooth.cn/html5/sextest/images/1-content@2x.png', // 分享图标
                desc: '经鉴定，我的性别指数为：50%纯爷们，50%小婊砸！', // 分享描述
                success: function () {
...
<body>
	...
	<div class="result_title">
		...
		<div class="content2">
			...
			<div class="cont_text"> 
				<img src="./images/3_content_txt_5.png" width="100%" heigth="100%">
			</div>
			<div class="res_word">
				<img src="./images/girl_txt5.png" width="100%" height="100%">
			</div>
		</div>
