    ...
    <script>
        ...
        wx.ready(function () {
            var shareTimelineData = {
                ...
                link: 'http://fenxiao.soundtooth.cn/html5/sextest/share_result_girl11.php', // 分享链接
...
<body>
	...
	<div class="result_title">
		...
		<div class="content2">
			...
			<div class="cont_text"> 
				<img src="./images/3_content_txt_0.png" width="100%" heigth="100%">
			</div>
			<div class="res_word">
				<img src="./images/girl_txt10.png" width="100%" height="100%">
			</div>
		</div>
		<div class="button" onclick="show_share();">
			<img  id="button_share"src="./images/btn_share_nor.png" width="100px" height="100px">
			<p>分享并领奖</p>
		</div>
	</div>
	<!-- 遮罩层 -->
