...
<script>
        ...
        wx.ready(function () {
            var shareTimelineData = {
                title: '【性别测试】经鉴定，我的性别指数为：20%纯爷们，80%小婊砸！', // 分享标题
                link: 'http://fenxiao.soundtooth.cn/html5/sextest/share_result_girl9.php', // 分享链接
            ...
            var shareData = {
                ...
                link: 'http://fenxiao.soundtooth.cn/html5/sextest/share_result_girl9.php', // 分享链接
                imgUrl: 'http://fenxiao.soundtooth.cn/html5/sextest/images/1-content@2x.png', // 分享图标
                desc: '经鉴定，我的性别指数为：20%纯爷们，80%小婊砸！', // 分享描述
...
<body>
	...
	<div class="result_title">
		...
		<div class="content2">
			...
			<div class="cont_text"> 
				<img src="./images/3_content_txt_9.png"width="100%" heigth="100%">
			</div>
			<div class="res_word">
				<img src="./images/girl_txt1.png"  width="100%" height="100%">
			</div>
		</div>
