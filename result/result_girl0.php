	...
	<script>
        ...
        wx.ready(function () {
            var shareTimelineData = {
                title: '【性别测试】经鉴定，我的性别指数为：100%纯爷们，0%小婊砸！', // 分享标题
                link: 'http://fenxiao.soundtooth.cn/html5/sextest/share_result_girl1.php', // 分享链接
            ...
            var shareData = {
                ...
                link: 'http://fenxiao.soundtooth.cn/html5/sextest/share_result_girl1.php', // 分享链接
                imgUrl: 'http://fenxiao.soundtooth.cn/html5/sextest/images/1-content@2x.png', // 分享图标
                desc: '经鉴定，我的性别指数为：100%纯爷们，0%小婊砸!', // 分享描述
...
<body>
	...
	<div class="backg">
		...
		<div class="per_pic4"></div>
		<div class="content2">
			<div class="cont_pic"></div>
			<div class="cont_text"> 
				<img src="./images/3_content_txt_10.png"width="100%" heigth="100%">
			</div>
			<div class="res_word">
				<img src="./images/girl_txt0.png"  width="100%" height="100%">
			</div>
		</div>
		<div class="button" onclick="show_share();">
			<img  id="button_share"src="./images/btn_share_nor.png">
			<p>分享并领奖</p>
		</div>
	</div>
	<!-- 遮罩层 -->
